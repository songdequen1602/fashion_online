...
<form action="{{route('slideshows.add')}}" method="post" enctype="multipart/form-data">
	@csrf
	...
	<div class="form-group">
		...
		<input type="text"  name="desccription" rows="10" class="form-control" value="{{ old('desccription') }}">
	...
	<div class="form-group">
		<label>url</label>
		<input type="text"  name="url" rows="10" class="form-control" value="{{ old('url') }}">
		<!-- @if($errors->first('url'))
	...
	<div class="form-group">
		...
		<input type="text"  name="order_number" rows="10" class="form-control" value="{{ old('order_number') }}">
