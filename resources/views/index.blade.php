      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red ">
            ...
            <div class="icon">
              <i class="fa fa-mail-hite "></i>
            </div>
            <a href="/slideshows" class="small-box-footer">Danh sách slideshows <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blue  ">
            ...
            <a href="/index" class="small-box-footer">Danh sách web-setting <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
